...
const TestimonialsCarousel = () => {
  ...
  const testimonials = [
    ...
    },
    {
      ...
      title: "Wheat & Cotton Producer",
      location: "Texas, Great Plains",
      ...
      quote: `The regional intelligence feature is incredible. It showed me that switching 400 acres from cotton to wheat would increase profitability by 22%. The prediction was accurate within 2 bushels per acre. This platform pays for itself many times over.`,
      metrics: {
        yieldIncrease: "22%",
        roi: "$120,000",
        accuracy: "94%"
    ...
    },
    {
      ...
      title: "Multi-Generational Farm Owner",
      location: "Nebraska, Midwest",
      farmSize: "3,200 acres",
      avatar: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150&h=150&fit=crop&crop=face",
      farmImage: "https://images.unsplash.com/photo-1625246333195-78d9c38ad449?w=600&h=400&fit=crop",
      quote: `Four generations of farming experience, and AgriPredict still teaches us something new every season. The AI caught a nutrient deficiency pattern we missed, leading to targeted fertilization that boosted yields across 800 acres.`,
      metrics: {
        yieldIncrease: "12%",
        roi: "$95,000",
        accuracy: "93%"
